...
public class MaoPractice2 {
    public static void main(String[] args) {
       ...
       // System.out.println(listOfMap);
        ...
        listOfMap.get(listOfMap.size()-1).replace("salary",(Integer)listOfMap.get(listOfMap.size()-1).get("salary")+15000);
        System.out.println(listOfMap);
        ...
        List<Map<String, Object>> listOdCars=new ArrayList<>(Arrays.asList(car1,car2,car3,car4));
