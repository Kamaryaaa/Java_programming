...
public class removeElementsFromCollection {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if(list.get(i) <4){
                list.remove(i);//avoid to use remove() inside a loop
            }
        ...
        System.out.println("=============removeIf();withString==================");

        ArrayList<String> names = new ArrayList<>();
        names.addAll(Arrays.asList("Java", "Python","C#","JavaScript","Ruby","C++","C"));
...
/*
 Write a program that can remove the elements that
 are less than 4, from an ArrayList of integer
