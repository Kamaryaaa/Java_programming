...
public class IPhone {
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof IPhone){// ig the given obj is iphone object
            if(model.equals( ( (IPhone) obj) .model) ){// if the model of the iphone is equal to the given iphones model
                if(color.equals(((IPhone) obj).color)){// if the color is equal
                    return true;
                }
            }
        }
